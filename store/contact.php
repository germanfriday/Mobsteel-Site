...
?></td>
          ...
          <td height="100%" align="left" valign="top"><!-- InstanceBeginEditable name="content" -->
            <table width="575" border="0" cellspacing="0" cellpadding="10">
              <tr>
                <td class="BlackText">If you would like to place an order, have questions about your order or would just like to learn more about Mobsteel you can contact our Customer Service dept. <br />
                  <br />
                1.810.333.6100, <br />
                <br />
                Monday-Friday, 9am - 5pm EST <br />
                <br />
                or email us at  <a href="mailto:sales@Mobsteel.com">sales@Mobsteel.com</a></td>
              </tr>
            </table>
            <p>&nbsp;</p>
<!-- InstanceEndEditable --></td>
